...
colnames(kmeans_cv_res) = c('Fold', 'LDA', 'Logistic Regression (Reg)', 'Logistic Regression', 'Naive Bayes', 
                            'QDA','Random Forest', 'XGBoost')

block_cv_res = CV_res$Block
colnames(block_cv_res) = c('Fold', 'LDA', 'Logistic Regression (Reg)', 'Logistic Regression', 'Naive Bayes', 
                            'QDA','Random Forest')
