...
xgboost_model = boost_tree(tree_depth = 12	, trees = 300, learn_rate = 0.0628, min_n = 14, loss_reduction= 0.0000317,
                           sample_size = 0.768, stop_iter = 17)%>%set_engine('xgboost') %>%set_mode('classification')
